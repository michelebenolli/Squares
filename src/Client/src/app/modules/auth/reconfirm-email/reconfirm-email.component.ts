...
@Component({
  selector: 'app-reconfirm-email',
  templateUrl: './reconfirm-email.component.html',
  styleUrls: ['./reconfirm-email.component.scss']
})
export class ReconfirmEmailComponent implements OnInit {
  ...
  onSubmit() {
    ...
    this.accountService.reconfirmEmail(email, this.tenant).subscribe(() => {
